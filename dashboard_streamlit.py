...
all_df = pd.read_csv(r"D:\belajar program\dashboar_sederhana_streamlit\all_data(1).csv")
...
#merupakan helper function yang digunakan untuk menyiapkan byage_df.
...
st.header('Reporting Analysis :sparkles:')
